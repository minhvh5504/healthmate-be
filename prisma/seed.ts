...
async function main() {
  ...
  const bmiBenchmarks = [
    // Males
    {
      ...
      value: 18.5,
      unit: 'kg/m2',
      description: 'Average for males under 18',
    },
    {
      type: 'BMI',
      gender: 'male',
      ...
      value: 24.9,
      unit: 'kg/m2',
      description: 'Average for males 18-24',
    },
    {
      type: 'BMI',
      gender: 'male',
      ...
      value: 25.5,
      unit: 'kg/m2',
      description: 'Average for males 25-34',
    },
    {
      type: 'BMI',
      gender: 'male',
      ...
      value: 26.2,
      unit: 'kg/m2',
      description: 'Average for males 35-44',
    },
    {
      type: 'BMI',
      gender: 'male',
      ...
      value: 26.5,
      unit: 'kg/m2',
      description: 'Average for males 45-54',
    },
    {
      type: 'BMI',
      gender: 'male',
      ...
      value: 25.8,
      unit: 'kg/m2',
      description: 'Average for males 55+',
    },
    // Females
    {
      type: 'BMI',
      ...
      value: 17.8,
      unit: 'kg/m2',
      description: 'Average for females under 18',
    },
    {
      type: 'BMI',
      gender: 'female',
      ...
      value: 22.5,
      unit: 'kg/m2',
      description: 'Average for females 18-24',
    },
    {
      type: 'BMI',
      gender: 'female',
      ...
      value: 23.8,
      unit: 'kg/m2',
      description: 'Average for females 25-34',
    },
    {
      type: 'BMI',
      gender: 'female',
      ...
      value: 25.0,
      unit: 'kg/m2',
      description: 'Average for females 35-44',
    },
    {
      type: 'BMI',
      gender: 'female',
      ...
      value: 25.5,
      unit: 'kg/m2',
      description: 'Average for females 45-54',
    },
    {
      type: 'BMI',
      gender: 'female',
      ...
      value: 24.8,
      unit: 'kg/m2',
      description: 'Average for females 55+',
    },
  ];
